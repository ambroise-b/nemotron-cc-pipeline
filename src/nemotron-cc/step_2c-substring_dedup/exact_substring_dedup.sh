...
export NUM_THREADS="${NUM_THREADS:-128}"  # value can be set up to as many cores as you have on your machine
export LENGTH_THRESHOLD=100
export BYTES_PER_TOKEN=2

# Override by exporting INPUT_PATH/MAIN_CACHE_PATH/OUTPUT_PATH before calling
# this script; these are just fallback defaults.
export INPUT_PATH="${INPUT_PATH:-/path/to/input/data}"
export MAIN_CACHE_PATH="${MAIN_CACHE_PATH:-/path/to/main/cache}"
export OUTPUT_PATH="${OUTPUT_PATH:-/path/to/output}"
