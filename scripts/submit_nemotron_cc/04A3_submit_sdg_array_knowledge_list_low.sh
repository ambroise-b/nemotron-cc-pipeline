#!/bin/bash
# Memory-safe rerun of the stage 4 (SDG) "knowledge_list" task, for shards that OOM'd at
...
#   ARRAY_RANGE=1,249 bash scripts/submit_nemotron_cc/04A3_submit_sdg_array_knowledge_list_low.sh
